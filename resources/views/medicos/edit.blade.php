                                                ...
                                                @method('PUT')
                                                    ...
                                                    <div class="row">													                                                    
                                                        ...
                                                        <div class="form-group col-2 m-0">
                                                            ...
                                                            <input type="text" class="form-control" id="registromedico" name="registromedico" value="{{old('registromedico',$medico->registromedico)}}" />
       ...
       const dropzone = new Dropzone('#dropzone',{
        ...
        init: function(){
            if(document.querySelector('[name="firma"]').value.trim()){
                ...
                this.options.thumbnail.call(this,imagenPublicada,`/storage/uploads/firmasradiologos/${imagenPublicada.name}`);
