...
$('#datatableDefault').DataTable({
    ...
    responsive: true,
    buttons: [  //{text: '<i class="fas fa-history"></i>', titleAttr: 'Refrescar', className: 'btn btn-indigo',action: function (e, dt, node, config) {$('#datatableDefault').DataTable().ajax.reload();}},
 ...
 function actulizar_filtros() {
    Livewire.emit('buscarSalas', buscar_salas);
    $('#datatableDefault').DataTable().clear().destroy();
    console.log("measdasd");
}
...
window.addEventListener('actalizar-tabla', () => {
...
//$('#datatableDefault').css('font-size', '0.8em');
    </script>
@endpush